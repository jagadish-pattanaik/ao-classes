...
public class Icseb10Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.icseb10);
	...
	private void initializeLogic() {
		setTitle("ICSE Class 10 Books");
		webview1.loadUrl("https://byjus.com/icse/class-10/");
