...
public class Icseb7Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.icseb7);
	...
	private void initializeLogic() {
		setTitle("ICSE Class 7 Books");
		webview1.loadUrl("https://byjus.com/icse/class-7/");
