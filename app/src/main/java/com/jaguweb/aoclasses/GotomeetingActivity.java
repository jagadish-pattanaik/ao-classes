...
public class GotomeetingActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.gotomeeting);
	...
	private void initializeLogic() {
		setTitle("GO TO MEETING");
		progressbar1.setVisibility(View.GONE);
		webview1.loadUrl("https://www.gotomeeting.com/en-in");
