...
public class DavQBankActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.dav_q_bank);
	...
	private void initializeLogic() {
		setTitle("D.A.V Q Bank");
		webview1.loadUrl("http://davjharsuguda.org/460C2D14-B155-4092-8B61-8907552ACEB0/CMS/Page/Question-Bank-2019-20");
		progressbar1.setVisibility(View.GONE);
