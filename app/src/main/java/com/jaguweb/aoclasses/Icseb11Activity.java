...
public class Icseb11Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.icseb11);
	...
	private void initializeLogic() {
		setTitle("ICSE Class 11 Books");
		webview1.loadUrl("https://byjus.com/icse/class-11/");
