...
public class SketchboardActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.sketchboard);
	...
	private void initializeLogic() {
		setTitle("Sketchboard");
		webview1.loadUrl("https://sketchboard.io/");
		progressbar1.setVisibility(View.GONE);
