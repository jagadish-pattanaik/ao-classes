...
public class BoardFoxActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.board_fox);
	...
	private void initializeLogic() {
		setTitle("Whiteboard Fox");
		webview1.loadUrl("https://whiteboardfox.com/");
		progressbar1.setVisibility(View.GONE);
