...
public class Icseb9Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.icseb9);
	...
	private void initializeLogic() {
		setTitle("ICSE Class 9 Books");
		webview1.loadUrl("https://byjus.com/icse/class-9/");
