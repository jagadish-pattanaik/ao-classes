...
public class MsTeamsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.ms_teams);
	...
	private void initializeLogic() {
		...
		progressbar1.setVisibility(View.GONE);
		webview1.loadUrl("https://www.microsoft.com/en-in/microsoft-365/microsoft-teams/group-chat-software");
