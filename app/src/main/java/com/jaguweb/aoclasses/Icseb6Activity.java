...
public class Icseb6Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.icseb6);
	...
	private void initializeLogic() {
		setTitle("ICSE Class 6 Books");
		webview1.loadUrl("https://byjus.com/icse/class-6/");
