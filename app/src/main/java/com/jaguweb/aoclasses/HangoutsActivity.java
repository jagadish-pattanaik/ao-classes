...
public class HangoutsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.hangouts);
	...
	private void initializeLogic() {
		setTitle("GOOGLE HANGOUTS");
		progressbar1.setVisibility(View.GONE);
		webview1.loadUrl("https://chrome.google.com/webstore/detail/google-hangouts/nckgahadagoaajjgafhacjanaoiihapd?hl=en");
