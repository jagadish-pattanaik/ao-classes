...
public class Icseb8Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.icseb8);
	...
	private void initializeLogic() {
		setTitle("ICSE Class 8 Books");
		webview1.loadUrl("https://byjus.com/icse/class-8/");
