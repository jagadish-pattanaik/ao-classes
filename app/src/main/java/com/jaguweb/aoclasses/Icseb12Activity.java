...
public class Icseb12Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.icseb12);
	...
	private void initializeLogic() {
		setTitle("ICSE Class 12 Books");
		webview1.loadUrl("https://byjus.com/icse/class-12/");
