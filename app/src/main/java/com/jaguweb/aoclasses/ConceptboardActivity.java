...
public class ConceptboardActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.conceptboard);
	...
	private void initializeLogic() {
		setTitle("Conceptboard");
		webview1.loadUrl("https://conceptboard.com/");
		progressbar1.setVisibility(View.GONE);
