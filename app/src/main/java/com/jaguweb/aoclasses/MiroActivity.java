...
public class MiroActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		setTitle("Miro");
		webview1.loadUrl("https://miro.com/?utm_source=zapier.com&utm_medium=referral&utm_campaign=zapier&utm_source=zapier.com&utm_medium=referral&utm_campaign=zapier");
		progressbar1.setVisibility(View.GONE);
